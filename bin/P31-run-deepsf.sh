...
perl /home/test/jie_test/multicom/src/meta/deepsf/script/tm_deepsf_main.pl /home/test/jie_test/multicom/src/meta/deepsf/deepsf_option $fastafile deepsf  2>&1 | tee  $outputdir/deepsf.log
...
if [[ ! -f "$outputdir/deepsf/deepsf1.pdb" ]];then 
	printf "!!!!! Failed to run deepsf, check the installation </home/test/jie_test/multicom/src/meta/deepsf/>\n\n"
else
