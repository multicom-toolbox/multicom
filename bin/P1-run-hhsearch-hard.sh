...
perl /storage/hpc/scratch/jh7x3/multicom/src/meta/hhsearch/script/tm_hhsearch_main_v2.pl /storage/hpc/scratch/jh7x3/multicom/src/meta/hhsearch/hhsearch_option_hard $fastafile hhsearch  2>&1 | tee   run_hhsearch.log
