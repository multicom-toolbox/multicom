...
cd $outputdir
perl /storage/hpc/scratch/jh7x3/multicom/src/meta/compass/script/tm_compass_main_v2.pl /storage/hpc/scratch/jh7x3/multicom/src/meta/compass/compass_option $fastafile compass  2>&1 | tee  compass.log
