...
cd $outputdir
perl /home/test/jie_test/multicom/src/meta/compass/script/tm_compass_main_v2.pl /home/test/jie_test/multicom/src/meta/compass/compass_option $fastafile compass  2>&1 | tee  compass.log
