...
cd $outputdir
perl /storage/hpc/scratch/jh7x3/multicom/src/meta/sam/script/tm_sam_main_v2.pl /storage/hpc/scratch/jh7x3/multicom/src/meta/sam/sam_option_hard $fastafile sam  2>&1 | tee  sam.log
