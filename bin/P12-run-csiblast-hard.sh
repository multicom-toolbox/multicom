...
cd $outputdir
perl /home/test/jie_test/multicom/src/meta/csblast/script/multicom_csiblast_v2.pl /home/test/jie_test/multicom/src/meta/csblast/csiblast_option_hard $fastafile csiblast  2>&1 | tee  csiblast.log
