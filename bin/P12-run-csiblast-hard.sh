...
cd $outputdir
perl /storage/hpc/scratch/jh7x3/multicom/src/meta/csblast/script/multicom_csiblast_v2.pl /storage/hpc/scratch/jh7x3/multicom/src/meta/csblast/csiblast_option_hard $fastafile csiblast  2>&1 | tee  csiblast.log
