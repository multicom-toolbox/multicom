...
perl /storage/hpc/scratch/jh7x3/multicom/src/meta/hhpred/script/tm_hhpred_main.pl /storage/hpc/scratch/jh7x3/multicom/src/meta/hhpred/hhpred_option $fastafile hhpred  2>&1 | tee  hhpred.log
