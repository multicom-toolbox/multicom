...
cd $outputdir
perl /home/jhou4/tools/multicom/src/meta/hhblits3/script/tm_hhblits3_main.pl /home/jhou4/tools/multicom/src/meta/hhblits3/hhblits3_option $fastafile  hhblits3  2>&1 | tee  hhblits3.log
perl /home/jhou4/tools/multicom/src/meta/hhblits3/script/filter_identical_hhblits.pl hhblits3
...
if [[ ! -f "$outputdir/hhblits3/hhbl2.pdb" ]];then 
	printf "!!!!! Failed to run hhblits3, check the installation </home/jhou4/tools/multicom/src/meta/hhblits3/>\n\n"
else
