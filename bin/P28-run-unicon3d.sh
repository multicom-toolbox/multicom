...
perl /storage/htc/bdm/jh7x3/multicom/src/meta/unicon3d/script/tm_unicon3d_main.pl /storage/htc/bdm/jh7x3/multicom/src/meta/unicon3d/Unicon3D_option $fastafile unicon3d  2>&1 | tee  unicon3d.log
...
if [[ ! -f "$outputdir/unicon3d/Unicon3d-1.pdb" ]];then 
	printf "!!!!! Failed to run unicon3d, check the installation </storage/htc/bdm/jh7x3/multicom/src/meta/unicon3d/>\n\n"
else
