...
@source_dir = ("psiblast", "csiblast", "hhsearch", "hhsearch15", "hmmer", "compass", "sam", "prc", "raptorx", "ffas", "hhsearch151", "hhblits", "muster", "hhpred", "hhsuite"); #six are based pdb_cm, four are based on sort90
