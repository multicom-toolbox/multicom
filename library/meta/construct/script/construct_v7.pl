...
@source_dir = ("psiblast", "csiblast", "hhsearch", "hhsearch15", "hmmer", "compass", "sam", "prc", "ffas", "hhsearch151", "hhblits", "muster", "hhpred", "hhsuite", "raptorx"); #six are based pdb_cm, four are based on sort90
