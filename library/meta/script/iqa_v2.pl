...
$iqa_script = "/storage/htc/bdm/tools/MULTICOM_CLUSTER/sunflower/chengji/casp8/model_cluster/script/iqa_v2.pl";
...
$cluster_dir = "/storage/htc/bdm/tools/MULTICOM_CLUSTER/sunflower/chengji/casp8/model_cluster/script/"; 
