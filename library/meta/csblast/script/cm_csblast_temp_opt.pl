...
if ($nr_db ne "none")
{
	system("$csblast_dir/csblast_static -i $seq_file -o $out_file -j $cm_blast_iteration -e $cm_blast_evalue -h $cm_including_evalue -d $temp_db -D $csblast_dir/K4000.lib --blast-path $blast_path"); 
