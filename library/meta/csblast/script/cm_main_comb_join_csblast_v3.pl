...
if (-d $nr_dir )
{
	...
	#system("$script_dir/cm_csblast_temp_opt.pl $option_file $fasta_file $fasta_file.blast"); 
	system("$script_dir/cm_csblast_temp_opt_v2.pl $option_file $fasta_file $fasta_file.blast"); 
}
else
{
