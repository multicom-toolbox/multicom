...
if (-d $nr_dir )
{
	...
	system("$script_dir/cm_csiblast_temp_opt.pl $option_file $fasta_file $fasta_file.blast"); 
}
else
{
...
#	`rm $lib_lock`; 
	...
	system("$script_dir/cm_csiblast_temp.pl $blast_dir none $pdb_db_dir/pdb_cm $fasta_file $fasta_file.blast $cm_blast_evalue"); 
