...
use lib "/storage/htc/bdm/tools/MULTICOM_CLUSTER/sunflower/chengji/casp8/hhsearch1.5/script/";
use Align;
# CUSTOMIZE
#my $dbbase="/storage/htc/bdm/tools/MULTICOM_CLUSTER/sunflower/chengji/cheng_group/hhsearch_dbs/nr"; # will use PSI-BLAST dbs $dbbase."90" and $dbbase."70" 
...
my $hh="/storage/htc/bdm/tools/MULTICOM_CLUSTER/sunflower/chengji/casp8/hhsearch1.5/script/";
my $perl=$hh;
