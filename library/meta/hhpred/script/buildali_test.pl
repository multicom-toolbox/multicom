...
use lib "/home/chengji/casp8/hhpred/script/";
use Align;
# CUSTOMIZE
#my $dbbase="/home/chengji/casp8/hhpred/nr/nr"; # will use PSI-BLAST dbs $dbbase."90" and $dbbase."70" 
#my $dbbase="/home/chengji/casp8/hhpred/nr_latest/nr"; # will use PSI-BLAST dbs $dbbase."90" and $dbbase."70" 
my $dbbase="/home/chengji/casp8/hhsearch_db/nr"; # will use PSI-BLAST dbs $dbbase."90" and $dbbase."70" 
                                   # It is recommended to use nre = nr + env. 
                                   # 90: filtered with CD-HIT to 90% maximum pairwise sequence identity
my $hh="/home/chengji/casp8/hhpred/script/";
my $perl=$hh;
my $ncbidir="/home/chengji/software/blast-2.2.17/bin"; # directory with ncbi BLAST binaries
my $blastpgp=$ncbidir."/blastpgp -I T -s T"; # blastpgp executable
#our $blastpgp.=" -I T -s T"; # show gi's in defline; use Smith-Waterman

my $execdir="/home/chengji/cheng_group/psipred-2.61/bin";  # directory with PSIPRED binaries 
my $datadir="/home/chengji/cheng_group/psipred-2.61/data"; # directory with PSIPRED data 
###########################################################################################################
...
print "input file: $infile $outdir\n";
...
sub blastpgp() {
    ...
    print "$blastpgp -b 20000 -v 1 $_[0] &> $_[1]\n"; 
