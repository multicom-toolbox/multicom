...
system("$multicom_dir/script/cm_main_comb_join_v2.pl $cm_option $query_file $output_dir");
...
system("$meta_common_dir/script/local_global_align.pl $align_option $query_file.local $query_file $query_file"); 
