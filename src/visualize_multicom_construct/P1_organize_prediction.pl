...
$scripts_dir = '/home/jh7x3/multicom/src/visualize_multicom_construct/';
if(!(-d $outputdir))
{
	`mkdir $outputdir`;
}
...
if(-e "$workdir/qa/deepcomb1.pdb")
{
	...
	#`/home/jh7x3/multicom/tools/molscript-2.1.2/molauto $outputdir/full_length/$targetid.deep1.pdb > $outputdir/full_length/$targetid-1.input`;
...
if(-e "$workdir/qa/deepcomb2.pdb")
{
	...
	#`/home/jh7x3/multicom/tools/molscript-2.1.2/molauto $outputdir/full_length/$targetid.deep2.pdb > $outputdir/full_length/$targetid-2.input`;
...
if(-e "$workdir/qa/deepcomb3.pdb")
{
	...
	#`/home/jh7x3/multicom/tools/molscript-2.1.2/molauto $outputdir/full_length/$targetid.deep3.pdb > $outputdir/full_length/$targetid-3.input`;
...
if(-e "$workdir/qa/deepcomb4.pdb")
{
	...
	#`/home/jh7x3/multicom/tools/molscript-2.1.2/molauto $outputdir/full_length/$targetid.deep4.pdb > $outputdir/full_length/$targetid-4.input`;
...
if(-e "$workdir/qa/deepcomb5.pdb")
{
	...
	##`/home/jh7x3/multicom/tools/molscript-2.1.2/molauto $outputdir/full_length/$targetid.deep5.pdb > $outputdir/full_length/$targetid-5.input`;
