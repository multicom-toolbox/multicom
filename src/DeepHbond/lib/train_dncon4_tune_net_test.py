...
min_hhbond_number = float(sys.argv[12])
...
if dataset == 'DEEPCOV_6463':
  path_of_lists   = GLOBAL_PATH+'/data/DEEPCOV/lists-test-train-6463-144/'
...
best_acc=Train_DeepHBond_2D_generator(feature_num,CV_dir,feature_dir,net_name,out_epoch,in_epoch,rerun_epoch, filtsize,
  ...
  runcount= index, if_use_binsize = False, min_hhbond_number = min_hhbond_number) #True
