...
print "Search $name against $hhsuitedb...\n";

#generate longer alignments, test on T8888
#system("$hhsuite3_dir/bin/hhblits -i $fasta_file -d $hhsuitedb -o $filename.hhr -realign -mact 0"); 

#generate short alignments, test on T8888
system("$hhsuite3_dir/bin/hhblits -i $fasta_file -d $hhsuitedb -o $filename.hhr"); 
