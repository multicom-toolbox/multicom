...
#library dir
$library_dir = "/storage/hpc/scratch/jh7x3/multicom/databases/library";
$input_file = "/storage/hpc/scratch/jh7x3/multicom/databases/fr_lib/sort90";
$output_db = "/storage/hpc/scratch/jh7x3/multicom/databases/ffas_dbs/multicom_db/multicom_ffas_db";
$db_profile_list = "/storage/hpc/scratch/jh7x3/multicom/databases/ffas_dbs/multicom_db/profile_list"; 
