...
#	if ($hour == 1 && $days[$day] == 0) #read hour 1, and is not updated today yet
    ...
    chdir($multicom_database_dir);
		...
		`date >> update.log`;
		print("/home/jhou4/tools/multicom/src/update_db/tools/ffas/build_db_update.pl $multicom_database_dir\n\n");
		system("/home/jhou4/tools/multicom/src/update_db/tools/ffas/build_db_update.pl $multicom_database_dir");
		`date >> update.log`;
		...
		`date >> update.log`; 
    print("/home/jhou4/tools/multicom/src/update_db/tools/hhsuite3/gen_db.sh $multicom_database_dir $option_file > hhsuite3.log\n\n");
		system("/home/jhou4/tools/multicom/src/update_db/tools/hhsuite3/gen_db.sh $multicom_database_dir $option_file > hhsuite3.log");
		`date >> update.log`;
		...
		`date >> update.log`; 
		print("/home/jhou4/tools/multicom/src/update_db/tools/hhsuite/gen_db.sh $multicom_database_dir > hhsuite.log\n\n");
		system("/home/jhou4/tools/multicom/src/update_db/tools/hhsuite/gen_db.sh $multicom_database_dir > hhsuite.log");
		`date >> update.log`;
