...
#	if ($hour == 1 && $days[$day] == 0) #read hour 1, and is not updated today yet
	{
		...
		`date >> update.log`; 
    print("/home/jh7x3/multicom/src/update_db/tools/hhsuite3/gen_db.sh $multicom_database_dir > hhsuite3.log\n\n");
		system("/home/jh7x3/multicom/src/update_db/tools/hhsuite3/gen_db.sh $multicom_database_dir > hhsuite3.log");
		`date >> update.log`;
