...
#	if ($hour == 1 && $days[$day] == 0) #read hour 1, and is not updated today yet
	{
		...
		`date >> update.log`;
		system("/home/jhou4/tools/multicom/src/update_db/tools/ffas/build_db_update.pl");
		`date >> update.log`;
		...
		print "finish updating FFAS database.\n";
			...
			`date >> update.log`; 
			system("/home/jhou4/tools/multicom/src/update_db/tools/hhsuite/gen_db.sh > hhsuite.log");
			`date >> update.log`;
			...
			`date >> update.log`; 
			system("/home/jhou4/tools/multicom/src/update_db/tools/hhsuite3/gen_db.sh > hhsuite3.log");
			`date >> update.log`;
