...
#do modeling
system("/home/casp14/MULTICOM_TS/multicom/src/prosys/script/pir2ts_energy.pl /home/casp14/MULTICOM_TS/multicom/tools/modeller7v7 $cur_dir/atomtmp $cur_dir/outtmp $output_pir 5");
