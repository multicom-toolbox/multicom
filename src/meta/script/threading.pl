...
#do modeling
system("/data/jh7x3/multicom_github/multicom/src/prosys/script/pir2ts_energy.pl /data/jh7x3/multicom_github/multicom/tools/modeller7v7 $cur_dir/atomtmp $cur_dir/outtmp $output_pir 5");
