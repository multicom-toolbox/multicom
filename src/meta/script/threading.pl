...
#do modeling
system("/home/jhou4/tools/multicom/src/prosys/script/pir2ts_energy.pl /home/jhou4/tools/multicom/tools/modeller7v7 $cur_dir/atomtmp $cur_dir/outtmp $output_pir 5");
