...
$seq = `/home/jhou4/tools/multicom/tools/model_eva1.0/script/pdb2seq.pl $in_pdb`;
...
system("/home/jhou4/tools/multicom/src/prosys/script/pir2ts_energy.pl /home/jhou4/tools/multicom/tools/modeller-9.16 $cur_dir/atomtmp $cur_dir/outtmp selftmp.pir 8");
