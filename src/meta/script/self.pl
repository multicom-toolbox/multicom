...
$seq = `/storage/htc/bdm/tianqi/MULTICOM2/tools/prosys/script/pdb2seq.pl $in_pdb`;
...
#do modeling
system("/storage/htc/bdm/tianqi/MULTICOM2/tools/prosys/script/pir2ts_energy.pl /storage/htc/bdm/tianqi/MULTICOM2/tools/modeller-9.16/ $cur_dir/atomtmp $cur_dir/outtmp selftmp.pir 5");
