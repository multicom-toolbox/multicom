...
$seq = `/data/jh7x3/multicom_github/jie_test/multicom/tools/model_eva1.0/script/pdb2seq.pl $in_pdb`;
...
system("/data/jh7x3/multicom_github/jie_test/multicom/src/prosys/script/pir2ts_energy.pl /data/jh7x3/multicom_github/jie_test/multicom/tools/modeller-9.16 $cur_dir/atomtmp $cur_dir/outtmp selftmp.pir 8");
