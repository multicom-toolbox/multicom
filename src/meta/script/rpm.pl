...
while (1)
{
	...
	system("$cluster_dir/consensus_qa.robust.casp9.pl $cluster_dir /home/chengji/software/spicker/spicker . $prev_global_quality_file $query_name $query_name.local.$iteration");
	...
	$refine_dir = ".";
	$refine_num = 100; 
	$multicom_dir = "/home/chengji/casp8/meta/script"; 
	system("$multicom_dir/script/refine_model_range.pl /home/chengji/cheng_group/bin/run_rosetta_refine.sh casp1.pdb  $refine_dir $refine_num 2>&1 1>/dev/null");
