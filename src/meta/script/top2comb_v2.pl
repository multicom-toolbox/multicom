...
if ($sim_score < $threshold)
{
	...
	`/home/casp13/MULTICOM_package/software/scwrl4/Scwrl4 -i $mname -o $mname.scw`;
	`/home/casp13/MULTICOM_package/casp8/meta/script/pdb2casp.pl $mname.scw 1 $tname casp1.pdb`;
}
else
{
