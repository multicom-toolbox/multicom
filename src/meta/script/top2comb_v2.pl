...
if ($sim_score < $threshold)
{
	...
	`/storage/htc/bdm/jh7x3/multicom/tools/scwrl4/Scwrl4 -i $mname -o $mname.scw`;
	`/storage/htc/bdm/jh7x3/multicom/src/meta/script/pdb2casp.pl $mname.scw 1 $tname casp1.pdb`;
}
else
{
