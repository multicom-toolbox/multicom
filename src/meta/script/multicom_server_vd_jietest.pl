...
@servers = ("hhsearch", "compass", "multicom", "csblast", "csiblast", "sam", "hmmer", "hmmer3", "blast", "psiblast", "hhsearch15", "prc", "raptorx", "newblast", "construct", "hhpred", "ffas", "hhblits", "hhblits3", "muster", "hhsearch151", "msa", "hhsuite3"); 
...
if ($i == $thread_num && $post_process == 0)
{
	...
	@servers = ("hhsearch", "compass", "multicom", "raptorx", "newblast", "csblast", "csiblast", "sam", "hmmer", "hmmer3", "blast", "psiblast", "hhsearch15", "prc", "construct", "hhpred", "hhblits", "hhblits3", "ffas", "muster", "hhsearch151", "hhsuite", "msa", "hhsuite3"); 
	for ($i = 0; $i < @servers; $i++)
	{
