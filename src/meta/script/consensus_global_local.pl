...
while ($count <= 5)
{
	...
	system("/data/jh7x3/multicom_github/jie_test/multicom/src/meta/model_cluster/script/stx_model_comb_global.pl /data/jh7x3/multicom_github/jie_test/multicom/tools/tm_score/TMscore_32 $casp_model_dir $name.score $fasta_file $output_dir/$name.pir 4 0.8 0.5");
	...
	while (@pir < 10)
	{
		...
		system("/data/jh7x3/multicom_github/jie_test/multicom/src/meta/model_cluster/script/stx_model_comb.pl /data/jh7x3/multicom_github/jie_test/multicom/tools/tm_score/TMscore_32 $casp_model_dir $name.score $fasta_file $output_dir/$name.pir 3 $length $gdt");
	...
	system("/data/jh7x3/multicom_github/jie_test/multicom/src/meta/model_cluster/script/pir2ts_energy.pl /data/jh7x3/multicom_github/jie_test/multicom/tools/modeller7v7/ $casp_model_dir $output_dir $output_dir/$name.pir 9");
