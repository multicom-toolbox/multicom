...
while ($count <= 5)
{
	...
	system("/home/jhou4/tools/multicom/src/meta/model_cluster/script/stx_model_comb_global.pl /home/jhou4/tools/multicom/tools/tm_score/TMscore_32 $casp_model_dir $name.score $fasta_file $output_dir/$name.pir 4 0.8 0.5");
	...
	while (@pir < 10)
	{
		...
		system("/home/jhou4/tools/multicom/src/meta/model_cluster/script/stx_model_comb.pl /home/jhou4/tools/multicom/tools/tm_score/TMscore_32 $casp_model_dir $name.score $fasta_file $output_dir/$name.pir 3 $length $gdt");
	...
	system("/home/jhou4/tools/multicom/src/meta/model_cluster/script/pir2ts_energy.pl /home/jhou4/tools/multicom/tools/modeller7v7/ $casp_model_dir $output_dir $output_dir/$name.pir 9");
	...
	#clash check
	system("/home/jhou4/tools/multicom/src/meta/model_cluster/script/clash_check.pl $fasta_file $output_dir/$name-$count.pdb > $output_dir/clash$count.txt"); 
	system("/home/jhou4/tools/multicom/src/meta/model_cluster/script/pdb2casp.pl $output_dir/$name-$count.pdb $count $name $output_dir/casp$count.pdb");
