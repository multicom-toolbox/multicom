...
while ($count <= 5)
{
	...
	system("/home/casp13/MULTICOM_package/casp8/model_cluster/script/stx_model_comb_global.pl /home/casp13/MULTICOM_package/software/tm_score/TMscore_32 $casp_model_dir $name.score $fasta_file $output_dir/$name.pir 2.5 0.8 0.5");
	...
	system("/home/casp13/MULTICOM_package/casp8/model_cluster/script/pir2ts_energy.pl /home/casp13/MULTICOM_package/software/prosys/modeller7v7/ $casp_model_dir $output_dir $output_dir/$name.pir 3");
...
#	system("/home/casp13/MULTICOM_package/software/scwrl/scwrl3 -i $output_dir/$name-$count.pdb -o $output_dir/$name-$count-s.pdb >/dev/null");
	...
	#clash check
	system("/home/casp13/MULTICOM_package/casp8/model_cluster/script/clash_check.pl $fasta_file $output_dir/$name-$count.pdb > $output_dir/clash$count.txt"); 
	system("/home/casp13/MULTICOM_package/casp8/model_cluster/script/pdb2casp.pl $output_dir/$name-$count.pdb $count $name $output_dir/casp$count.pdb");
