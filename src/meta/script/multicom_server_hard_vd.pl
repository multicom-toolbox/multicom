...
@servers = ("hhsearch", "compass", "raptorx", "csiblast", "sam", "hmmer", "hmmer3", "psiblast", "newblast", "blast", "hhsearch15", "prc", "construct", "hhpred", "hhblits", "hhblits3", "ffas", "muster", "hhsearch151", "hhsuite3", "msa", "confold", "rosettacon", "unicon3d","rosetta2", "rosetta3", "rosetta4", "rosetta5", "rosetta6", "rosetta7"); 
...
for ($i = 0; $i < @servers; $i++)
{
	...
	elsif ($kidpid == 0)
	{
		...
		elsif ($server eq "rosettacon")
		{
			...
			while(1) # added by jie on 2018/04/09
			{
				if(-e $dncon_check)
				{
					last;
...
if ($i == $thread_num && $post_process == 0)
{
	...
	@servers = ("hhsearch", "compass", "csiblast", "sam", "hmmer", "hmmer3", "psiblast", "newblast", "blast", "hhsearch15", "prc", "rosetta2", "rosetta3", "rosetta4", "rosetta5", "rosetta6", "rosetta7", "construct", "hhpred", "hhblits", "hhblits3", "ffas", "muster", "hhsearch151", "hhsuite", "hhsuite3", "raptorx", "msa", "confold", "rosettacon", "unicon3d"); 
	for ($i = 0; $i < @servers; $i++)
	{
