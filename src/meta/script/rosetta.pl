...
if (@ARGV != 4)
{
	die "need four parameters: rosetta dir, fasta file, number of simulations, output dir.\n"; 
}
...
system("$abinitio_dir/rosettaAB.pl -binary $rosetta_dir/RosettaAbinitio/source/rosetta.gcc -fasta $pseudo_name.fasta -nstruct $sim_num -outdir ./ -verbose -additional_args \"-constant_seed\" >ab.log 2>&1");
