...
while ($i <= $count && @eva)
{
	...
	system("/home/casp14/MULTICOM_TS/jie_test/multicom/src/meta/model_cluster/script/clash_check.pl $fasta_file $out_dir/$model_name.pdb.scw > $out_dir/clash$i.txt");
