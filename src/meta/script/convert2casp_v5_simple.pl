...
while ($i <= $count && @eva)
{
	...
	system("/data/jh7x3/multicom_github/jie_test/multicom/src/meta/model_cluster/script/clash_check.pl $fasta_file $out_dir/$model_name.pdb.scw > $out_dir/clash$i.txt");
