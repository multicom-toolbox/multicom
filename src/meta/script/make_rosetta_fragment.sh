...
export LD_LIBRARY_PATH=/storage/htc/bdm/jh7x3/multicom/tools/rosetta3.1/rosetta_source/build/src/release/linux/2.6/64/x86/gcc/:$LD_LIBRARY_PATH

ROSETTA_PATH='/storage/htc/bdm/jh7x3/multicom/tools/rosetta3.1'
