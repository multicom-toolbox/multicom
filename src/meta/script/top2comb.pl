...
if ($sim_score < $threshold)
{
	...
	`/storage/htc/bdm/tools/MULTICOM_CLUSTER/sunflower/chengji/software/scwrl4/Scwrl4 -i $mname -o $mname.scw`;
	`/storage/htc/bdm/tools/MULTICOM_CLUSTER/sunflower/chengji/casp8/meta/script/pdb2casp.pl $mname.scw 1 $tname casp1.pdb`;
}
else
{
