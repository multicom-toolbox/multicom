...
#############################domain combination########################################
$cm_model_num = 5; 
$modeller_dir = "/home/casp14/MULTICOM_TS/multicom/tools/modeller9v7/"; 
$prosys_dir = "/home/casp14/MULTICOM_TS/multicom/src/prosys/";
$final_model_num = 5; 
...
for ($m = 0; $m < @servers; $m++)
{
	...
	for ($i = 0; $i < $final_model_num; $i++)
	{
		...
		if ( -f "$comb_dir/$server$idx.pdb")
		{
			...
			system("/home/casp14/MULTICOM_TS/multicom/tools/scwrl4/Scwrl4 -i $comb_dir/$server$idx.pdb -o $comb_dir/$server$idx.pdb.scw >/dev/null");
			system("/home/casp14/MULTICOM_TS/multicom/src/meta/model_cluster/script/clash_check.pl $fasta_file $comb_dir/$server$idx.pdb.scw > $comb_dir/$server-clash$idx.txt");
