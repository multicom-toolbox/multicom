...
#############################domain combination########################################
$cm_model_num = 5; 
$modeller_dir = "/home/test/jie_test/multicom/tools/modeller9v7/"; 
$prosys_dir = "/home/test/jie_test/multicom/src/prosys/";
$final_model_num = 5; 
$pdb2casp2 = "/home/test/jie_test/multicom/src/meta/script/pdb2casp.pl";
...
for ($m = 0; $m < @servers; $m++)
{
	...
	for ($i = 0; $i < $final_model_num; $i++)
	{
		...
		if ( -f "$comb_dir/$server$idx.pdb")
		{
			...
			system("/home/test/jie_test/multicom/tools/scwrl4/Scwrl4 -i $comb_dir/$server$idx.pdb -o $comb_dir/$server$idx.pdb.scw >/dev/null");
			system("/home/test/jie_test/multicom/src/meta/model_cluster/script/clash_check.pl $fasta_file $comb_dir/$server$idx.pdb.scw > $comb_dir/$server-clash$idx.txt");
