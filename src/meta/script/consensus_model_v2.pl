...
for ($i = 1; $i <= 5; $i++)
{
	...
	if (-f $model_file)
	{
		system("/home/chengji/software/scwrl4/Scwrl4 -i $model_file -o $consensus_dir/$model_name-$i.pdb.scw >/dev/null");
		#system("/home/chengji/software/scwrl4/Scwrl4 -i $model_file -o $consensus_dir/$model_name-$i.pdb.scw");
		
		system("/home/chengji/casp8/model_cluster/script/clash_check.pl $model_dir/$target_name.FASTA $consensus_dir/$model_name-$i.pdb.scw > $consensus_dir/clash$i.txt");
