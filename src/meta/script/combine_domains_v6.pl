...
foreach $model (@models)
{
	...
	for ($jj = 1; $jj <= 5; $jj++)
	{
		...
		system("/home/casp14/MULTICOM_TS/jie_test/multicom/src/meta/model_cluster/script/clash_check.pl $fasta_file $model_file.scw > $deepcomb_dir/clash-$model$jj.txt");
