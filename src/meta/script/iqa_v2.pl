...
$iqa_script = "/data/jh7x3/multicom_github/jie_test/multicom/src/meta/model_cluster/script/iqa_v2.pl";
...
$spicker = "/data/jh7x3/multicom_github/jie_test/multicom/tools/spicker/spicker";
