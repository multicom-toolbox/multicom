...
use lib "/home/casp14/MULTICOM_TS/jie_github/multicom/src/meta/hhsearch1.5/script/";
use Align;
# CUSTOMIZE
...
my $hh="/home/casp14/MULTICOM_TS/jie_github/multicom/src/meta/hhsearch1.5/script/";
my $perl=$hh;
