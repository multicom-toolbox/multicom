...
use lib "/storage/hpc/scratch/jh7x3/multicom/src/meta/hhsearch1.5/script/";
use Align;
# CUSTOMIZE
...
my $dbbase="/storage/hpc/scratch/jh7x3/multicom/databases/nr70_90/nr"; # will use PSI-BLAST dbs $dbbase."90" and $dbbase."70" 
                                   # It is recommended to use nre = nr + env. 
                                   # 90: filtered with CD-HIT to 90% maximum pairwise sequence identity
my $hh="/storage/hpc/scratch/jh7x3/multicom/src/meta/hhsearch1.5/script/";
my $perl=$hh;
