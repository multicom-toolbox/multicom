...
use lib "/home/casp14/MULTICOM_TS/jie_test/multicom/src/meta/hhsearch1.5/script/";
use Align;
# CUSTOMIZE
...
my $hh="/home/casp14/MULTICOM_TS/jie_test/multicom/src/meta/hhsearch1.5/script/";
my $perl=$hh;
