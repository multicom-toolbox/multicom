...
use lib "/home/casp13/MULTICOM_package/casp8/hhsearch1.5/script/";
use Align;
# CUSTOMIZE
...
my $dbbase="/home/casp13/MULTICOM_package/nr/nr"; # will use PSI-BLAST dbs $dbbase."90" and $dbbase."70" 
                                   # It is recommended to use nre = nr + env. 
                                   # 90: filtered with CD-HIT to 90% maximum pairwise sequence identity
my $hh="/home/casp13/MULTICOM_package/casp8/hhsearch1.5/script/";
my $perl=$hh;
