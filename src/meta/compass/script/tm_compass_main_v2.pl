...
system("$compass_dir/compass_search/compass_vs_db -e $cm_blast_evalue -i $name.paln -d $compassdb$index -o $name.com$index");
...
if ($total <= 0)
{
	#create a dummy file for construct program to go ahead	
