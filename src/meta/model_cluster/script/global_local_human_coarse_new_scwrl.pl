...
while ($count <= 5)
{
	...
	system("/home/chengji/casp8/model_cluster/script/pir2ts_energy.pl /home/chengji/software/prosys/modeller7v7/ $casp_model_dir $output_dir $output_dir/$name.pir 5");
