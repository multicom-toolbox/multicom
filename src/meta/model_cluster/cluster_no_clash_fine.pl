...
$spicker = "/home/chengji/software/spicker/spicker_fine";
...
for ($i = 283; $i <= 386; $i++)
{
	...
	system("./script/cluster_casp_model_noclash.pl ./script/ $spicker $tdir $score_file $seq_dir/$target fine_$target"); 	
