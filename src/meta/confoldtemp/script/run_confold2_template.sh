...
echo "perl /home/jhou4/tools/multicom/src/meta/confoldtemp/script/run_confold2_template.pl $targetid   $fasta /home/jhou4/tools/multicom/src/meta/confoldtemp/script/CONFOLD_Template_option   $outputfolder   $contact_file  $ss_file\n"
perl /home/jhou4/tools/multicom/src/meta/confoldtemp/script/run_confold2_template.pl $targetid   $fasta /home/jhou4/tools/multicom/src/meta/confoldtemp/script/CONFOLD_Template_option $multicom_full_length_hard  $outputfolder   $contact_file   $ss_file
