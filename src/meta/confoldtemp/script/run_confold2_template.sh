...
echo "perl /home/test/jie_test/multicom/src/meta/confoldtemp/script/run_confold2_template.pl $targetid   $fasta /home/test/jie_test/multicom/src/meta/confoldtemp/script/CONFOLD_Template_option   $outputfolder   $contact_file  $ss_file\n"
perl /home/test/jie_test/multicom/src/meta/confoldtemp/script/run_confold2_template.pl $targetid   $fasta /home/test/jie_test/multicom/src/meta/confoldtemp/script/CONFOLD_Template_option $multicom_full_length_hard  $outputfolder   $contact_file   $ss_file
