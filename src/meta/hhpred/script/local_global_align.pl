...
$align_dir="/storage/htc/bdm/tools/MULTICOM_CLUSTER/sunflower/chengji/casp8/hhpred/script"; 
...
use lib "/storage/htc/bdm/tools/MULTICOM_CLUSTER/sunflower/chengji/casp8/meta/script/";
use Align; 
