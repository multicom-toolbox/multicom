...
@source_dir = ("psiblast", "csiblast", "hhsearch", "hhsearch15", "hmmer", "compass", "sam", "prc", "raptorx", "ffas", "hhsearch151", "hhblits", "hhblits3", "muster", "hhpred", "hhsuite"); #six are based pdb_cm, four are based on sort90
...
`touch $work_dir/blast/$fasta_file.local`;
...
for ($i = 0; $i < $construct_num && $i < @select_temp; $i++)
{
	...
	#$hhsearch_dir = "/home/chengji/software/hhsearch1.2/linux32/";
  $hhsearch_dir = "/storage/htc/bdm/tools/MULTICOM_CLUSTER/sunflower/chengji/software/hhsearch1.2/linux64/";
