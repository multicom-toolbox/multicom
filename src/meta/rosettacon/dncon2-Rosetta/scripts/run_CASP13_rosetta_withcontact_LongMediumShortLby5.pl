...
if(-e "$ren_rosetta_dir/abini/aaabini03_05.200_v1_3" and -e "$ren_rosetta_dir/abini/aaabini09_05.200_v1_3")
{
	...
	print "4. Generating rosetta fragments\n/home/casp13/dncon2-Rosetta/scripts/make_rosetta_fragment.sh $fasta_seq abini $ren_rosetta_dir 100  &>> $dir_output/runRosetta_LongMediumShortLby5.log\n\n";
	`/home/casp13/dncon2-Rosetta/scripts/make_rosetta_fragment.sh $fasta_seq abini $ren_rosetta_dir 100  &>> $dir_output/runRosetta_LongMediumShortLby5.log`;
}
#(need discuss which nr database use in make_fragment.pl)

print "5. Running rosetta with contact constraints\n/home/casp13/dncon2-Rosetta/scripts/run_rosetta_no_fragment_withContact.sh $fasta_seq abini $ren_rosetta_dir   100 $ren_rosetta_dir/$targetname.rr.LongMediumShortLby5.contact.cst $weight &>> $dir_output/runRosetta_LongMediumShortLby5.log\n\n";
`/home/casp13/dncon2-Rosetta/scripts/run_rosetta_no_fragment_withContact.sh $fasta_seq abini $ren_rosetta_dir   100 $ren_rosetta_dir/$targetname.rr.LongMediumShortLby5.contact.cst $weight &>> $dir_output/runRosetta_LongMediumShortLby5.log`;
...
chdir("/home/casp13/deepsf_3d/deepsf3d_tools/SBROD");
