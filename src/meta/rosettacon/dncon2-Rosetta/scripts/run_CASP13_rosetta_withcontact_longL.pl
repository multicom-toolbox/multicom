...
my($ren_rosetta_dir)=$dir_output."/rosetta_results_${targetname}_longL";
...
print "1. Filtering dncon2 \nperl /home/casp13/dncon2-Rosetta/scripts/convea_range_resultv2.pl -rr $targetname.dncon2.rr  -fasta $fasta_seq  -smin 24 -smax 10000 -top L\n";
`perl /home/casp13/dncon2-Rosetta/scripts/convea_range_resultv2.pl -rr $targetname.dncon2.rr  -fasta $fasta_seq  -smin 24 -smax 10000 -top L`;


print "2. Generating dncon2 constraints\nperl /home/casp13/dncon2-Rosetta/scripts/P1_convert_dncon2constraints.pl $targetname-Long-range-L.rr.raw  $fasta_seq $targetname.rr.longL.contact.cst 3.5 8\n";
`perl /home/casp13/dncon2-Rosetta/scripts/P1_convert_dncon2constraints.pl $targetname-Long-range-L.rr.raw  $fasta_seq $targetname.rr.longL.contact.cst 3.5 8`;



if(!(-e "$targetname.rr.longL.contact.cst"))
{
	die "Failed to generate $targetname.rr.longL.contact.cst\n\n";
}
...
if(-e "$ren_rosetta_dir/abini/aaabini03_05.200_v1_3" and -e "$ren_rosetta_dir/abini/aaabini09_05.200_v1_3")
{
	...
	print "4. Generating rosetta fragments\n/home/casp13/dncon2-Rosetta/scripts/make_rosetta_fragment.sh $fasta_seq abini $ren_rosetta_dir 100  &>> $dir_output/runRosetta_longL.log\n\n";
	`/home/casp13/dncon2-Rosetta/scripts/make_rosetta_fragment.sh $fasta_seq abini $ren_rosetta_dir 100  &>> $dir_output/runRosetta_longL.log`;
}
#(need discuss which nr database use in make_fragment.pl)

print "5. Running rosetta with contact constraints\n/home/casp13/dncon2-Rosetta/scripts/run_rosetta_no_fragment_withContact.sh $fasta_seq abini $ren_rosetta_dir   100 $ren_dncon2_features/$targetname.rr.longL.contact.cst &>> $dir_output/runRosetta_longL.log\n\n";
`/home/casp13/dncon2-Rosetta/scripts/run_rosetta_no_fragment_withContact.sh $fasta_seq abini $ren_rosetta_dir   100 $ren_dncon2_features/$targetname.rr.longL.contact.cst &>> $dir_output/runRosetta_longL.log`;
