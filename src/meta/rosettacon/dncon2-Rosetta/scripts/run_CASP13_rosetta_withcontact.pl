...
print "4. Generating rosetta fragments\n/home/casp13/dncon2-Rosetta/scripts/make_rosetta_fragment.sh $fasta_seq abini $ren_rosetta_dir 100\n\n";
`/home/casp13/dncon2-Rosetta/scripts/make_rosetta_fragment.sh $fasta_seq abini $ren_rosetta_dir 100`;

#(need discuss which nr database use in make_fragment.pl)

print "5. Running rosetta with contact constraints\n/home/casp13/dncon2-Rosetta/scripts/run_rosetta_no_fragment_withContact.sh $fasta_seq abini $ren_rosetta_dir   100 $ren_dncon2_features/$targetname.dncon2.contact.cst\n\n";
`/home/casp13/dncon2-Rosetta/scripts/run_rosetta_no_fragment_withContact.sh $fasta_seq abini $ren_rosetta_dir   100 $ren_dncon2_features/$targetname.dncon2.contact.cst`;
