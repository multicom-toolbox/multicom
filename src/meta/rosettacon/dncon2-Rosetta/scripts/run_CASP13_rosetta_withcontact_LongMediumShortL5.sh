...
echo "perl /home/casp14/MULTICOM_TS/jie_github/multicom/src/meta/rosettacon/dncon2-Rosetta/scripts/run_CASP13_rosetta_withcontact_LongMediumShortLby5.pl $targetid   $fasta  $dir_output  $contact_file $fragmentdir $lbound $ubound $weight"
perl /home/casp14/MULTICOM_TS/jie_github/multicom/src/meta/rosettacon/dncon2-Rosetta/scripts/run_CASP13_rosetta_withcontact_LongMediumShortLby5.pl $targetid   $fasta  $dir_output  $contact_file $fragmentdir $lbound $ubound $weight
