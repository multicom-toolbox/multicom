...
$seq = `/data/jh7x3/multicom_github/multicom/tools/model_eva1.0/script/pdb2seq.pl $in_pdb`;
...
#do modeling
system("/data/jh7x3/multicom_github/multicom/src/prosys/script/pir2ts_energy.pl /data/jh7x3/multicom_github/multicom/tools/modeller9v7 $cur_dir/atomtmp $cur_dir/outtmp selftmp.pir 5");
