...
#do modeling
system("/home/test/jie_test/multicom/src/prosys/script/pir2ts_energy.pl /home/test/jie_test/multicom/tools/modeller9v7 $cur_dir/atomtmp $cur_dir/outtmp selftmp.pir 5");
