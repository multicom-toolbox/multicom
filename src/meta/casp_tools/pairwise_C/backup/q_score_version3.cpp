...
int main(int argc, char* argv[]){
	...
	for(int i = 0; i < Ca.size(); i++){    //Ca.size() returns the number of models
		...
		tm_map[tm_score] = model_id;
		gdt_ts_map[gdt_ts] = model_id;
		max_sub_map[max_sub] = model_id;
		q_score_map[q_score] = model_id;
