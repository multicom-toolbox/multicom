...
##########################################################################
#hhsuite3 programs used to build protein structures
#Created in 2018
##########################################################################
...
print("$hhsuite_dir/bin/hhblits -i $fasta_file -d $nr_db -oa3m $name.a3m -n $nr_iteration_num\n"); 
system("$hhsuite_dir/bin/hhblits -i $fasta_file -d $nr_db -oa3m $name.a3m -n $nr_iteration_num"); 
...
print("$hhsuite_dir/bin/hhblits -i $name.ss.a3m -d $hhsuitedb\n");
system("$hhsuite_dir/bin/hhblits -i $name.ss.a3m -d $hhsuitedb");

print "generate ranking list...\n";
system("$meta_dir/script/rank_templates.pl $filename.ss.hhr $work_dir/$name.rank");

#parse the blast output
print "parse hhsearch output...\n"; 

system("$meta_dir/script/parse_hhsearch.pl $filename.ss.hhr $fasta_file.local");
