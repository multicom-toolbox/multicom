...
use lib "/data/jh7x3/multicom_github/jie_test/multicom/src/meta/hhsearch151/script/";
use Align;
# CUSTOMIZE
...
my $dbbase="/data/jh7x3/multicom_github/jie_test/multicom/databases/nr70_90/nr";
my $hh="/data/jh7x3/multicom_github/jie_test/multicom/src/meta/hhsearch151/script/";
my $perl=$hh;
