...
echo "perl /home/casp14/MULTICOM_TS/jie_test/multicom/src/meta/fusioncon/fusion/scripts/run_CASP13_fusion_withcontact_LongMediumShortLby5.pl $targetid   $fasta  $dir_output  $contact_file $max_wait_time $lbound $ubound $weight"
perl /home/casp14/MULTICOM_TS/jie_test/multicom/src/meta/fusioncon/fusion/scripts/run_CASP13_fusion_withcontact_LongMediumShortLby5.pl $targetid   $fasta  $dir_output  $contact_file $max_wait_time $lbound $ubound $weight
