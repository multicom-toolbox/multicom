...
$saxs_file = $ARGV[4]; # optional
$saxs_weight = $ARGV[5]; # optional
$max_wait_time = $ARGV[6]; # optional
$lbound = $ARGV[7]; # optional
$ubound = $ARGV[8]; # optional
$weight = $ARGV[9]; # optional
...
if(-e "$ren_dncon2_features/$targetname.dncon2.rr")
{
	print "1. Filtering dncon2 \nperl /home/casp13/dncon2-Rosetta/scripts/convea_range_resultv2.pl -rr $targetname.dncon2.rr  -fasta $fasta_seq  -smin 24 -smax 10000 -top L5\n\n";
	`perl /home/casp13/dncon2-Rosetta/scripts/convea_range_resultv2.pl -rr $targetname.dncon2.rr  -fasta $fasta_seq  -smin 24 -smax 10000 -top L5`;

	print "1. Filtering dncon2 \nperl /home/casp13/dncon2-Rosetta/scripts/convea_range_resultv2.pl -rr $targetname.dncon2.rr  -fasta $fasta_seq  -smin 12 -smax 23 -top L5\n\n";
	`perl /home/casp13/dncon2-Rosetta/scripts/convea_range_resultv2.pl -rr $targetname.dncon2.rr  -fasta $fasta_seq  -smin 12 -smax 23 -top L5`;

	print "1. Filtering dncon2 \nperl /home/casp13/dncon2-Rosetta/scripts/convea_range_resultv2.pl -rr $targetname.dncon2.rr  -fasta $fasta_seq  -smin 6 -smax 11 -top L5\n\n";
	`perl /home/casp13/dncon2-Rosetta/scripts/convea_range_resultv2.pl -rr $targetname.dncon2.rr  -fasta $fasta_seq  -smin 6 -smax 11 -top L5`;


	print "2. Generating dncon2 constraints\nperl /home/casp13/dncon2-Rosetta/scripts/P1_convert_dncon2constraints.pl $targetname-Long-range-L5.rr.raw  $fasta_seq $targetname.rr.longL5.contact.cst  $lbound  $ubound\n\n";
	`perl /home/casp13/dncon2-Rosetta/scripts/P1_convert_dncon2constraints.pl $targetname-Long-range-L5.rr.raw  $fasta_seq $targetname.rr.longL5.contact.cst $lbound  $ubound`;

	print "2. Generating dncon2 constraints\nperl /home/casp13/dncon2-Rosetta/scripts/P1_convert_dncon2constraints.pl $targetname-Short-range-L5.rr.raw  $fasta_seq $targetname.rr.shortL5.contact.cst  $lbound  $ubound \n\n";
	`perl /home/casp13/dncon2-Rosetta/scripts/P1_convert_dncon2constraints.pl $targetname-Short-range-L5.rr.raw  $fasta_seq $targetname.rr.shortL5.contact.cst $lbound  $ubound `;

	print "2. Generating dncon2 constraints\nperl /home/casp13/dncon2-Rosetta/scripts/P1_convert_dncon2constraints.pl $targetname-Medium-range-L5.rr.raw  $fasta_seq $targetname.rr.mediumL5.contact.cst $lbound  $ubound\n\n";
	`perl /home/casp13/dncon2-Rosetta/scripts/P1_convert_dncon2constraints.pl $targetname-Medium-range-L5.rr.raw  $fasta_seq $targetname.rr.mediumL5.contact.cst $lbound  $ubound`;
...
print "5. Running fusion with contact constraints\n/home/casp13/fusion/scripts/Fusion_Abinitio_with_contact_SAXS.sh  --target  $targetname  --fasta $fasta_seq  --email jh7x3\@mail.missouri.edu --dir $ren_fusion_dir  --timeout  $max_wait_time  --constraint $ren_fusion_dir/$targetname.rr.LongMediumShortLby5.contact.cst --cpu 5 --decoy 1000 --model  5   --saxsprofile    $saxs_file  --saxs_weight $saxs_weight  &> $dir_output/runFusion_LongMediumShortLby5.log\n\n";
`/home/casp13/fusion/scripts/Fusion_Abinitio_with_contact_SAXS.sh  --target  $targetname  --fasta $fasta_seq  --email jh7x3\@mail.missouri.edu --dir $ren_fusion_dir  --timeout  $max_wait_time  --constraint $ren_fusion_dir/$targetname.rr.LongMediumShortLby5.contact.cst --cpu 5 --decoy 1000 --model  5  --saxsprofile    $saxs_file --saxs_weight $saxs_weight &> $dir_output/runFusion_LongMediumShortLby5.log`;
...
print("/home/casp13/Confold2-Unicon3D/UniCon3D//maxcluster64bit -l  $ren_fusion_dir/model.list -ms 5 -C 5 -is $clusternum  > $maxcluster_score_file\n");
system("/home/casp13/Confold2-Unicon3D/UniCon3D//maxcluster64bit -l  $ren_fusion_dir/model.list -ms 5 -C 5 -is $clusternum  > $maxcluster_score_file"); 
