...
parser.add_option( '--saxsprofile', dest = 'saxsprofile',  ## added by jie 2018/05/22
	default = '',    # default empty!
	help = 'saxs profile for the target')
parser.add_option( '--saxs_weight', dest = 'saxs_weight',  ## added by jie 2018/05/22
...
saxsprofile = options.saxsprofile  ## added by jie 2018/05/22
saxs_weight = options.saxs_weight  ## added by jie 2018/05/22
...
modeling = FusionModeling_SAXS_Lite() 
...
modeling.set_saxs_profiles(saxsprofile) ## added by Jie on 09/16/2016
modeling.set_saxs_weight(saxs_weight) ## added by Jie on 09/16/2016
