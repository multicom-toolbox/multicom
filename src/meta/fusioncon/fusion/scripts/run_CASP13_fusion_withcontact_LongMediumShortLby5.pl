...
print("/data/jh7x3/multicom_github/jie_test/multicom/tools/maxcluster64bit -l  $ren_fusion_dir/model.list -ms 5 -C 5 -is $clusternum  > $maxcluster_score_file\n");
system("/data/jh7x3/multicom_github/jie_test/multicom/tools/maxcluster64bit -l  $ren_fusion_dir/model.list -ms 5 -C 5 -is $clusternum  > $maxcluster_score_file"); 
