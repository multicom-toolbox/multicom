...
####################################################################################################
use constant{
	CONEVA      => '/storage/hpc/scratch/jh7x3/multicom/src/visualize_multicom_cluster/cmap/coneva.pl',
	CMAP      => '/storage/hpc/scratch/jh7x3/multicom/src/visualize_multicom_cluster/cmap/cmap.pl',
};
