...
####################################################################################################
use constant{
	CONEVA      => '/storage/htc/bdm/jh7x3/multicom/src/visualize_multicom_cluster/cmap/coneva.pl',
	CMAP      => '/storage/htc/bdm/jh7x3/multicom/src/visualize_multicom_cluster/cmap/cmap.pl',
};
