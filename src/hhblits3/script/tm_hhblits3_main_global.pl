...
print("$hhblits3_dir/bin/hhblits -i $name.ss.a3m -d $hhblits3_pdb_hmm_db -glob -o $name.glo.hhr\n");
#system("$hhblits3_dir/bin/hhblits -i $name.hmm -d $hhblits3_pdb_hmm_db");
system("$hhblits3_dir/bin/hhblits -i $name.ss.a3m -d $hhblits3_pdb_hmm_db -glob -o $name.glo.hhr");


print "generate ranking list...\n";
#system("$meta_dir/script/rank_templates.pl $filename.hhr $work_dir/$name.rank");
print("$meta_dir/script/rank_templates.pl $name.glo.hhr $work_dir/$name.grank\n");
...
system("$meta_dir/script/filter_rank.pl $pdb_db_dir/pdb_cm $name.grank $name.filter.grank");
...
system("$meta_dir/script/filter_alignments.pl $pdb_list_dir/pdb.list $fasta_file.global $fasta_file.global.fil");

`cp $fasta_file.global $fasta_file.global.org`;
`mv $fasta_file.global.fil $fasta_file.global`; 

#remove templates from rank file
system("$meta_dir/script/filter_rank_file.pl $pdb_list_dir/pdb.list $work_dir/$name.grank $work_dir/$name.grank.fil");
`cp $work_dir/$name.grank $work_dir/$name.grank.org`;
`cp $work_dir/$name.grank.fil $work_dir/$name.grank`; 
