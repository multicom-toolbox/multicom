...
if ($alignment_method ne "clustalw" && $alignment_method ne "lobster" && $alignment_method ne "palign" && $alignment_method ne "palign_ss" && $alignment_method ne "tcoffee")
{
	die "profile-profile alignment method is not specified. (must be clustalw, lobster, tcoffee or palign)\n";
}
