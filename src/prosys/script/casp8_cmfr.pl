...
$cm_sel = `/home/jh7x3/multicom_beta1.0/src/prosys/script/evaluate_cm_hh_models.pl /home/jh7x3/multicom_beta1.0/src/prosys/ $out_dir $name $out_dir/$name.cm.eva`;
...
if (! -f "$out_dir/cm.pdb" && ! -f "$out_dir/cm1.pdb" &&  ! -f "$out_dir/cm0.pdb")
{
	...
	system("/home/jh7x3/multicom_beta1.0/src/prosys/script/multicom_cm.pl $cm_option_nr $seq_file $out_dir");
} 
else
{
...
else
{
	...
	system("/home/jh7x3/multicom_beta1.0/src/prosys/script/evaluate_models_nofr.pl /home/jh7x3/multicom_beta1.0/src/prosys/ $out_dir $seq_file $out_dir/$name.fr.eva");
	goto CM;
}
