...
system("/storage/htc/bdm/jh7x3/multicom/src/meta/hhsearch/script/tm_hhsearch_main.pl $cm_option $seq_file $out_dir");
...
else
{
	...
	system("/storage/htc/bdm/jh7x3/multicom/src/prosys/script/evaluate_models_nofr.pl /storage/htc/bdm/jh7x3/multicom/src/prosys/ $out_dir $seq_file $out_dir/$name.fr.eva");
	goto CM;
}
