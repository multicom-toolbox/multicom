...
for ($i = 0; $i < @rank_models; $i++)
{
	...
	print OUT $rank_models[$i]{"svm_score"}, "\t";
	print OUT $rank_models[$i]{"hhs_evalue"}, "\t";
	print OUT $rank_models[$i]{"com_evalue"}, "\t";
	print OUT $rank_models[$i]{"ssm_score"}, "\t";
	print OUT $rank_models[$i]{"sam_score"}, "\t";
