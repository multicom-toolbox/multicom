...
print "Combine Comparative Modeling Alignments...\n";
system("$script_dir/cm_main_comb_align.pl $cm_option $query_file $output_dir");
print "Done.\n";
...
system("$script_dir/combine_sig_svm_full.pl $script_dir $output_dir $output_dir/$query_name.rank $svm_comb_threshold $output_dir/frcom.pir 2>/dev/null");
