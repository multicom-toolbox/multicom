...
#Date: 12/30/2005
#date: 3/13/2008 (fix a bug in parse_domain_v2.pl)
##########################################################################
...
print DOM "AUTHOR FOLDpro-dom\n";
print DOM "METHOD domain prediction based on fold recognition of FOLDpro\n";
print DOM "METHOD FOLDpro: Cheng and Baldi.Bioinformatics,2006:22:1456-1463.\n";
$ord = 1; 
$num = @domains; 
