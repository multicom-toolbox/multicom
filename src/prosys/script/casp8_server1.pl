...
$cm_sel = `/home/casp14/MULTICOM_TS/jie_github/multicom/src/prosys/script/evaluate_cm_ha_models.pl $out_dir $name $out_dir/$name.cm.eva`;
...
system("/home/casp14/MULTICOM_TS/jie_github/multicom/src/prosys/evaluate_models.pl /home/casp14/MULTICOM_TS/jie_github/multicom/src/prosys/ $out_dir $seq_file ./$out_dir/$name.fr.eva");
