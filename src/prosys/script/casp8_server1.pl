...
$cm_sel = `/home/jhou4/tools/multicom/src/prosys/script/evaluate_cm_ha_models.pl $out_dir $name $out_dir/$name.cm.eva`;
...
system("/home/jhou4/tools/multicom/src/prosys/evaluate_models.pl /home/jhou4/tools/multicom/src/prosys/ $out_dir $seq_file ./$out_dir/$name.fr.eva");
