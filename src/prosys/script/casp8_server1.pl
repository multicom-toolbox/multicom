...
$cm_sel = `/data/jh7x3/multicom_github/jie_test/multicom/src/prosys/script/evaluate_cm_ha_models.pl $out_dir $name $out_dir/$name.cm.eva`;
...
system("/data/jh7x3/multicom_github/jie_test/multicom/src/prosys/evaluate_models.pl /data/jh7x3/multicom_github/jie_test/multicom/src/prosys/ $out_dir $seq_file ./$out_dir/$name.fr.eva");
