#!/usr/bin/perl -w
##############################################################################
#The simple main control script of Fold Recognition using simple combination
#of alignments. (modified from fr_main_simple.pl)
#It does four things: 
#	1)generate query required files
#	2)rank the templates for the query
#	3)generate alignments between query and templates
#       4)Combined alignments using simple gap driven approach. (New)
