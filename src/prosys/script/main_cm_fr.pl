...
system("$script_dir/cm_main_comb.pl $cm_option $query_file $output_dir");
print "Done.\n";
...
system("$script_dir/fr_main_adv_comb.pl $fr_option $query_file $output_dir");
print "Done.\n";
