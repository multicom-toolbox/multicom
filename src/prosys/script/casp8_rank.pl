...
system("/home/casp14/MULTICOM_TS/jie_test/multicom/src/meta/hhsearch/script/tm_hhsearch_main.pl $cm_option $seq_file $out_dir 1>out.log 2>err.log");
...
if (@hhrank < 2)
{
	...
	system("/home/casp14/MULTICOM_TS/jie_test/multicom/src/meta/hhsearch/script/tm_hhsearch_main.pl $cm_option_nr $seq_file $out_dir");
}
else
{
	$top_temp = $hhrank[1];
...
else
{
	...
	system("/home/casp14/MULTICOM_TS/jie_test/multicom/src/prosys/script/evaluate_models_nofr.pl /home/casp14/MULTICOM_TS/jie_test/multicom/src/prosys/ $out_dir $name $out_dir/$name.fr.eva");
	goto CM;
}
