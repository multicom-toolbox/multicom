...
#	3. feature_align_seq_norm.pl (sequence alignment info using palign/clustalw)
...
#	16. hhm_prc.pl  (using prc prof-prof alignment)
#	17. hhm_search.pl  (using hhsearch prof-prof alignment)
#	18. coach.pl (lobster)
#	19. compass.pl
...
#
#Modified from feature_lobster.pl
#Use lobster global alignment as the basis of extracting structural features.
#Author: Jianlin Cheng
#Date started: 8/27/05
######################################################################################
...
while (<OPTION>)
{
	...
	if ($_ =~ /^fr_stx_feature_alignment\s*=\s*(\S+)/)
	{
...
system("$script_dir/feature_align_seq_norm.pl $script_dir $palign_dir palign $query_file fasta $target_file fasta > $query_file.fea"); 
...
if ($fr_stx_feature_alignment ne "lobster_no_clustalw")
{
	system("$script_dir/feature_align_seq_norm.pl $script_dir $clustalw_dir clustalw $query_file fasta $target_file fasta > $query_file.fea"); 
...
#18. lobster.pl: lobster dir, query fasta file, query fas file, target fasta file, target fas, target lob file,  output file
print "extract hmm profile-profile alignment feature using lobster...\n";
$feature_name .=  "lobster_score ";
push @attr_names, ("lobster_score");
...
if ($fr_stx_feature_alignment eq "muscle" || $fr_stx_feature_alignment eq "lobster_no_clustalw")
{
	system("$script_dir/muscle.pl $lobster_dir $query_file $query_fas $target_file $temp_fas $temp_lob $query_file.fea > /dev/null"); 
}
else #using lobster
{
	system("$script_dir/coach.pl $lobster_dir $query_file $query_fas $target_file $temp_fas $temp_lob $query_file.fea > /dev/null"); 
}
open(RES, "$query_file.fea") || die "can't read lobster profile alignment features.\n";
@fea = <RES>;
close RES;
$fea_num = shift @fea;
if ($fea_num =~ /^feature num:\s*(\d+)/)
...
{
	die "fail to extract lobster profile-profile alignment features.\n"; 
}
$fea_values = shift @fea;
@values = split(/\s+/, $fea_values);
if ($fea_num != @values)
{
	die "lobster profile-profile alignment feature num doesn't match with feature values.\n"; 
}
$feature .= join(" ", @values). " "; 
push @attr_values, @values; 
if (@attr_names != @attr_values)
...
#`rm $query_file.fea`; 
#use lobster alignment file as the basis of extracting structural features
`mv $query_file.fea $query_file.lobster`; 
...
#set upper bound on the evalue log(max_evalue)
if ($values[1] > log(1000))
{
	$values[1] = log(1000); 
}
$feature .= join(" ", @values). " "; 
...
#set upper threshold on evalue using log(max_evalue)
if ($values[1] > log(20))
{
	$values[1] = log(20); 
}
...
#12. feature_ssa_global.pl: query file(fasta), query cm file(conpro foramt), target file(9-line set format, no title), alignment file(global alignment from lobster)

print "extract ss, sa info using lobster  alignments...\n";
...
system("$script_dir/feature_ssa_global.pl $query_file $query_cm $temp_set $query_file.lobster >$query_file.fea"); 
...
#13. feature_cm_global.pl: query file(fasta), query cm file(conpro foramt), target file(9-line set format, no title), alignment file(global alignment from lobster), contact threshold

print "extract cm8a info using lobster  alignments...\n";
$feature_name .=  "norm_contact_prob_8a cosin_of_residue_contact_num corr_of_residue_contact_num cosin_of_residue_contact_ord corr_of_residue_contact_ord";
push @attr_names, ("norm_contact_prob_8a", "cosin_of_residue_contact_num", "corr_of_residue_contact_num", "cosin_of_residue_contact_ord", "corr_of_residue_contact_ord");
$query_cm = "$query_dir/$qname.cm8a";
-f $query_cm || die "can't find query cm8a file: $query_cm\n"; 
$temp_set = "$template_dir/$tname.set";
-f $temp_set || die "can't find template dataset file: $temp_set\n"; 
system("$script_dir/feature_cm_global.pl $script_dir $query_file $query_cm $temp_set $query_file.lobster  8 >$query_file.fea"); 
...
print "extract bcm8a info using lobster  alignments...\n";
$feature_name .=  "norm_contact_prob_bcm8a cosin_of_residue_contact_num corr_of_residue_contact_num cosin_of_residue_contact_ord corr_of_residue_contact_ord";
push @attr_names, ("norm_contact_prob_bcm8a", "cosin_of_residue_contact_num", "corr_of_residue_contact_num", "cosin_of_residue_contact_ord", "corr_of_residue_contact_ord");
...
print "extract cm12a info using lobster  alignments...\n";
#$feature_name .=  "norm_contact_prob_12a ";
$feature_name .=  "norm_contact_prob_cm12a cosin_of_residue_contact_num corr_of_residue_contact_num cosin_of_residue_contact_ord corr_of_residue_contact_ord";
push @attr_names, ("norm_contact_prob_cm12a", "cosin_of_residue_contact_num", "corr_of_residue_contact_num", "cosin_of_residue_contact_ord", "corr_of_residue_contact_ord");
$query_cm = "$query_dir/$qname.cm12a";
-f $query_cm || die "can't find query cm12a file: $query_cm\n"; 
$temp_set = "$template_dir/$tname.set";
-f $temp_set || die "can't find template dataset file: $temp_set\n"; 
system("$script_dir/feature_cm_global.pl $script_dir $query_file $query_cm $temp_set $query_file.lobster  12 >$query_file.fea"); 
...
print "extract bcm12a info using lobster  alignments...\n";
$feature_name .=  "norm_contact_prob_bcm12a cosin_of_residue_contact_num corr_of_residue_contact_num cosin_of_residue_contact_ord corr_of_residue_contact_ord";
push @attr_names, ("norm_contact_prob_bcm12a", "cosin_of_residue_contact_num", "corr_of_residue_contact_num", "cosin_of_residue_contact_ord", "corr_of_residue_contact_ord");
$query_cm = "$query_dir/$qname.bcm12a";
-f $query_cm || die "can't find query bcm12a file: $query_cm\n"; 
$temp_set = "$template_dir/$tname.set";
-f $temp_set || die "can't find template dataset file: $temp_set\n"; 
system("$script_dir/feature_cm_global.pl $script_dir $query_file $query_cm $temp_set $query_file.lobster  12 >$query_file.fea"); 
open(RES, "$query_file.fea") || die "can't read cm12a features using global alignment.\n";
...
{
	die "fail to extract bcm12a features from global alignment.\n"; 
}
$fea_values = shift @fea;
@values = split(/\s+/, $fea_values);
if ($fea_num != @values)
{
	die "bcm12a feature number from global alignment doesn't match with feature values.\n"; 
}
$feature .= join(" ", @values). " "; 
push @attr_values, @values; 
if (@attr_names != @attr_values)
...
#14. feature_bcm_global.pl: query file(fasta), query beta residue pairing file, target file(9-line set format, no title), alignment file(from lobster).

print "extract betamap info using lobster  alignments...\n";
...
$temp_set = "$template_dir/$tname.set";
-f $temp_set || die "can't find template dataset file: $temp_set\n"; 
system("$script_dir/feature_bcm_global.pl $query_file $query_cm $temp_set $query_file.lobster >$query_file.fea"); 
...
#16. hhm_prc.pl: prchmm dir, query fasta file, query hmm file, target hmm, output file
#It generates three features for each call.

print "extract hmm profile-profile alignment feature using hhm_prc...\n";
$feature_name .=  "hmm-coemis hmm-simple hmm-reverse ";
push @attr_names, ("hmm-coemis", "hmm-simple", "hmm-reverse");
$query_hmm = "$query_dir/$qname.hmm"; 
-f $query_hmm || die "can't find query hmm file: $query_hmm\n"; 
$temp_hmm = "$template_dir/$tname.hmm"; 
-f $temp_hmm || die "can't find target hmm file: $temp_hmm\n"; 
system("$script_dir/hhm_prc.pl $prc_dir $query_file $query_hmm $temp_hmm $query_file.fea > /dev/null"); 
open(RES, "$query_file.fea") || die "can't read prc hmm profile alignment features.\n";
@fea = <RES>;
close RES;
$fea_num = shift @fea;
if ($fea_num =~ /^feature num:\s*(\d+)/)
...
{
	die "fail to extract prc profile-profile alignment features.\n"; 
}
$fea_values = shift @fea;
@values = split(/\s+/, $fea_values);
if ($fea_num != @values)
{
	die "prc profile-profile alignment feature num doesn't match with feature values.\n"; 
}
$feature .= join(" ", @values). " "; 
push @attr_values, @values; 
if (@attr_names != @attr_values)
...
print "extract chk profile-profile alignment feature using hhm_prc...\n";
$feature_name .=  "chk-coemis chk-simple chk-reverse ";
push @attr_names, ("chk-coemis", "chk-simple", "chk-reverse");
$query_chk = "$query_dir/$qname.chk"; 
-f $query_chk || die "can't find query chk file: $query_chk\n"; 
$query_prof = "$qname.prof";
#create a link between prof file and chk file
`ln -s $query_chk $query_prof`; 

$temp_chk = "$template_dir/$tname.chk"; 
-f $temp_chk || die "can't find target chk file: $temp_chk\n"; 
$temp_prof = "$tname.prof";
`ln -s $temp_chk $temp_prof`; 

system("$script_dir/hhm_prc.pl $prc_dir $query_file $query_prof $temp_prof $query_file.fea > /dev/null"); 
`rm $temp_prof`;
`rm $query_prof`; 
open(RES, "$query_file.fea") || die "can't read prc chk profile alignment features.\n";
@fea = <RES>;
close RES;
$fea_num = shift @fea;
if ($fea_num =~ /^feature num:\s*(\d+)/)
...
#17. hhm_search.pl: hhsearch dir, query fasta file, query hhm file, target hhm, output file
print "extract hhm profile-profile alignment feature using hhm_search...\n";
$feature_name .=  "hhsearch_score ";
push @attr_names, ("hhsearch_score");
$query_hhm = "$query_dir/$qname.hhm"; 
-f $query_hhm || die "can't find query hhm file: $query_hhm\n"; 
$temp_hhm = "$template_dir/$tname.hhm"; 
-f $temp_hhm || die "can't find target hhm file: $temp_hhm\n"; 

system("$script_dir/hhm_search.pl $hhsearch_dir $query_file $query_hhm $temp_hhm $query_file.fea > /dev/null"); 

open(RES, "$query_file.fea") || die "can't read hhsearch profile alignment features.\n";
@fea = <RES>;
close RES;
$fea_num = shift @fea;
if ($fea_num =~ /^feature num:\s*(\d+)/)
...
{
	die "fail to extract hhsearch profile-profile alignment features.\n"; 
}
$fea_values = shift @fea;
@values = split(/\s+/, $fea_values);
if ($fea_num != @values)
{
	die "hhsearch profile-profile alignment feature num doesn't match with feature values.\n"; 
}
$feature .= join(" ", @values). " "; 
push @attr_values, @values; 
if (@attr_names != @attr_values)
...
#19. compass.pl: compass dir, query fasta file, query aln file, target aln, output file

print "extract log_exp profile-profile alignment feature using compass...\n";
$feature_name .=  "compass-score compass-evalue ";
push @attr_names, ("compass-score", "compass-evalue");
$query_aln = "$query_dir/$qname.aln"; 
-f $query_aln || die "can't find query aln file: $query_aln\n"; 
$temp_aln = "$template_dir/$tname.aln"; 
-f $temp_aln || die "can't find target aln file: $temp_aln\n"; 
system("$script_dir/compass.pl $compass_dir $query_file $query_aln $temp_aln $query_file.fea > /dev/null"); 
open(RES, "$query_file.fea") || die "can't read compass profile alignment features.\n";
@fea = <RES>;
close RES;
$fea_num = shift @fea;
if ($fea_num =~ /^feature num:\s*(\d+)/)
...
{
	die "fail to extract compass profile-profile alignment features.\n"; 
}
$fea_values = shift @fea;
@values = split(/\s+/, $fea_values);
if ($fea_num != @values)
{
	die "compass profile-profile alignment feature num doesn't match with feature values.\n"; 
}
$feature .= join(" ", @values). " "; 
push @attr_values, @values; 
if (@attr_names != @attr_values)
