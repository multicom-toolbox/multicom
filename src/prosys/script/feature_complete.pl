...
#
#Modified from feature_all.pl (add new features, and normalize clustalw sequence
#alignment score using query_length instead of 100. 
#
#Author: Jianlin Cheng
#Date started: 7/27/05
######################################################################################
...
print "extract bcm12a info using clustalw  alignments...\n";
