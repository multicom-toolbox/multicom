...
# lite version - only calculates precision
# Written by Badri Adhikari - May 2016
...
# perl coneva-lite.pl -rr T0000.rr -pdb T0000.pdb >> T0000_rr.txt
use strict;
use warnings;
use Carp;
use File::Basename;
...
if (not -f $in_pdb_file){
	print "\nERROR!! PDB file $in_pdb_file does not exist!!\n";
	print_usage() 
}
if (not -f $in_rr){
