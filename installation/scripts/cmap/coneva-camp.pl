...
####################################################################################################
use constant{
	CONEVA      => '/storage/hpc/scratch/jh7x3/multicom/installation/scripts/cmap/coneva.pl',
	CMAP      => '/storage/hpc/scratch/jh7x3/multicom/installation/scripts/cmap/cmap.pl',
};
