...
printf "\nFinished.."
printf "\nCheck log file </data/jh7x3/multicom_github/jie_test/multicom/test_out/T0993s2-blast-$dtime.log>\n\n"


if [[ ! -f "/data/jh7x3/multicom_github/jie_test/multicom/test_out/T0993s2-blast-$dtime/blast/hs1.pdb" ]];then 
	printf "!!!!! Failed to run blast, check the installation </data/jh7x3/multicom_github/jie_test/multicom/src/meta/blast/>\n\n"
else
	printf "\nJob successfully completed!"
	printf "\nResults: /data/jh7x3/multicom_github/jie_test/multicom/test_out/T0993s2-blast-$dtime/blast/hs1.pdb\n\n"
fi
