...
if [[ ! -f "/home/jh7x3/multicom/test_out/T0993s2_fusioncon_$dtime/fusioncon/fusioncon1.pdb" ]];then 
	printf "!!!!! Failed to run fusioncon, check the installation </home/jh7x3/multicom/src/meta/fusioncon/>\n\n"
else
	printf "\nJob successfully completed!"
	printf "\nResults: /home/jh7x3/multicom/test_out/T0993s2_fusioncon_$dtime/fusioncon/fusioncon1.pdb\n\n"
fi
