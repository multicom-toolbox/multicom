...
perl /storage/htc/bdm/tianqi/test/MULTICOM2/multicom/src/deephhsuite/script/tm_deephhsuite_main_v2.pl /storage/htc/bdm/tianqi/test/MULTICOM2/multicom/src/deephhsuite/deephhsuite_option_v2 $fastafile $deepmsa deephhsuite  2>&1 | tee  deephhsuite.log
