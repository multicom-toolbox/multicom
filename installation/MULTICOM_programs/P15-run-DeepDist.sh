...
cd $outputdir
sh  /storage/htc/bdm/tianqi/test/MULTICOM2/multicom/tools/deepdist/predictors/ensemble/pred_deepdist2.sh $fastafile $outputdir/deepmsa/$targetid.aln $outputdir/disthbond/  2>&1 | tee  disthbond.log
